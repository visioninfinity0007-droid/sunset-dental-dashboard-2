...
export default function AuditPage() {
  ...
  const exportCSV = () => {
    ...
    const headers = ["Timestamp", "Actor", "Action", "Target Type", "Target ID", "IP Address", "Metadata"];
      ...
      <div className="px-8 pb-8 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <button 
            ...
            className="bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors disabled:opacity-50 sm:ml-auto"
          >
            Export CSV
          </button>
        </div>
